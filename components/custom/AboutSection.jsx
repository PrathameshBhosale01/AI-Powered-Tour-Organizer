...
return (
  <section id="about" className="py-20 min-h-content w-full">
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-16 h-full w-full">

      {/* LEFT: About text section */}
      <motion.div
      ...
      >
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 font-medium">
            Meet the Visionary Behind Your Journey
          </p>
        </motion.div>
        ...
        >
          I’m a passionate developer using AI and design to make trip planning effortless, inspiring adventures and creating lasting memories.
        </motion.p>
      </motion.div>

      {/* RIGHT: Single Team Member Card */}
      <motion.div
        ref={ref}
      ...
      >
        {teamMembers.slice(0, 1).map((member, index) => (
          <motion.div
            ...
            className="flex flex-col items-center bg-indigo-300 hover:shadow-2xl dark:bg-indigo-900 w-full max-w-[280px] rounded-lg p-6 gap-4 shadow-lg"
          >
            {/* Image */}
            <motion.div
              whileHover={{ scale: 1.1, rotate: 5 }}
              className="relative w-28 h-28 md:w-36 md:h-36 lg:w-40 lg:h-40 rounded-full overflow-hidden shadow-2xl ring-4 ring-white dark:ring-gray-800 mb-4"
            >
            ...
            <motion.div variants={linkVariants} className="flex gap-2">
              <motion.a href={member.linkedin} whileHover={{ scale: 1.2, rotate: 5 }}
              ...
              <motion.a href={member.github} whileHover={{ scale: 1.2, rotate: -5 }}
              ...
              <motion.a href={`mailto:${member.email}`} whileHover={{ scale: 1.2, rotate: 5 }}
